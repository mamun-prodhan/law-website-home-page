...
const DetailsBannerCase = () => {
    ...
    return (
        <div className="my-10 md:my-16 lg:my-32 px-4 md:px-10 lg:px-20 flex flex-col lg:flex-row items-center gap-10 md:gap-16 lg:gap-60">
...
export default DetailsBannerCase;