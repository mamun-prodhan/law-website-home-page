    ...
    <div>
      ...
      <div className="w-full bg-[#1B2946]">
        <div className="ps-0 md:ps-10 lg:ps-14 pt-8 md:pt-10 lg:pt-14 pb-3 ">
          <img
            className="mx-auto md:mx-0 lg:mx-0 w-[114px] md:w-[144px] lg:w-[154px]"
            src={logo}
            alt="logo"
          />
        </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="py-8 md:py-10 lg:py-16 ps-4 md:ps-10 lg:ps-16 flex-1 bg-[#1C2946] text-[#FFF]">
          <h2 className="text-xl md:text-2xl lg:text-5xl font-semibold mb-6 md:mb-6 lg:mb-14">
            EMERGENCY?
          </h2>
          <p className="text-lg md:text-lg lg:text-2xl text-[#B5E6EA] mb-2 md:mb-2 lg:mb-6 font-medium">
            Call 24 hours a day , 7 days a week .
          </p>
          <p className="text-lg md:text-lg lg:text-2xl underline mb-6 md:mb-6 lg:mb-20 font-medium">
            0121 345 9067
          </p>
